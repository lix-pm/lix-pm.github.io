// polyfill fetch(), copied from https://cdnjs.cloudflare.com/ajax/libs/fetch/2.0.3/fetch.min.js
...
window.$docsify.plugins.push(function(hook, vm) {
	hook.beforeEach(function (html, next) {
		...
		if(repo == '')	
			repo = 'lix-pm.github.io/blob/master';
		else
			repo += '/blob/gh-pages';
		...
		var footer = ['[Edit this page](https://github.com/lix-pm/' + repo + path + ')\n'];
